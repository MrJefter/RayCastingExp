...
//!
//! @note    Не все форматы файлов поддерживаются. Файл должен быть в формате WAV, Microsoft PCM, Стерео (2 канала),
//!          скорость семплирования 44.100 кГц (@ref txWaveSampleRate), 16 бит на канал. Если файл другого формата,
//!          его надо преобразовать в нужный формат. Например, программой "CoolEdit 2000" или аналогичной. @nn
//!          Кроме того, если при загрузке файла не хватило памяти, он не будет загружен. Проверьте размер вектора,
//!          возвращенного функцией, вызвав для него функцию-член @c .size().
//!
